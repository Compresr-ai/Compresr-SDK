...
class TestCompressionRatios:
    ...
    def test_different_ratios(self, admin_client, ratio):
        ...
        # Actual ratio should be reasonably close to target
...
class TestBatchOperations:
    ...
    def test_small_batch(self, admin_client):
        """Test batch with 3 contexts."""
        contexts = [
            "First context for batch compression.",
            "Second context with different content.",
            "Third context to complete the batch.",
        ]
    ...
    def test_large_batch(self, admin_client):
        """Test batch with 20 contexts."""
