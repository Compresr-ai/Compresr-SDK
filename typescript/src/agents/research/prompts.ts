 ...
 */
export const DEFAULT_RESEARCH_SYSTEM_PROMPT = `You are a research agent. The user will ask you a specific question whose answer cannot be reliably produced from your internal weights (hallucination risk is high), and that takes several steps of web research to resolve.
